...
To make another chip/card the master chip. just add/replace the comparitor in line 52 of the code with the new chips ID and flash the ESP. To find out what the chips ID is, tap it on the reader and check it out on the serial output.

"Card ID : YOUR_CARD_ID has not registered.
------------"

  Heres the line you need to edit:
52  if (card_num.equals("040646F2AD6F80")){

change it to   if (card_num.equals("YOUR_CARD_ID")){
